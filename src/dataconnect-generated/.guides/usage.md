...
```ts
import { useListAccounts, useCreateContact, useGetMyOpportunities, useUpdateOpportunityStage } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useGetMyOpportunities();
...
```js
import { listAccounts, createContact, getMyOpportunities, updateOpportunityStage } from '@dataconnect/generated';
