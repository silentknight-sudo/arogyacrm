...
const AiLeadScoringAndPrioritizationInputSchema = z.object({
  ...
  productAsked: z.array(z.string()).optional().describe('The list of specific product IDs or product categories the lead has inquired about.'),
...
- **Product Asked**: Specific interest in high-value products should increase the score.
...
Products of Interest: {{{productAsked}}}
Demographic Data:
