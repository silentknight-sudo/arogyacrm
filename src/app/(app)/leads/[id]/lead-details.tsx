            ...
            <CardContent className="space-y-4 text-sm">
                ...
                {lead?.productAsked && (
                 ...
                 <div className="flex items-center gap-3">
                    ...
                    <span className="truncate">Assigned to {assignedCount} user(s)</span>
                </div>
                {lead?.source && (
                    <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        <span>Status:</span>
                        <Badge variant={statusVariantMap[lead?.status || 'New']} className="capitalize">{lead?.status || 'New'}</Badge>
                    </div>
                </div>
            </CardContent>
        </Card>
